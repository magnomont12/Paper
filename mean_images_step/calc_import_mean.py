...
def calc_distance_blends(step):
    ...
    for model in models:
        matrix_blend = [
            [f"image_grad-cam_scores_scores_{model}_0_original_basic_basic", f"image_grad-cam_scores_scores_{model}_2_blend_basic_animated_ba_25", f"image_grad-cam_scores_scores_{model}_2_blend_basic_animated_ba_50", f"image_grad-cam_scores_scores_{model}_2_blend_basic_animated_ba_75", f"image_grad-cam_scores_scores_{model}_0_original_animated_animated"],
            [f"image_grad-cam_scores_scores_{model}_0_original_basic_basic", f"image_grad-cam_scores_scores_{model}_2_blend_basic_caco_bc_25", f"image_grad-cam_scores_scores_{model}_2_blend_basic_caco_bc_50", f"image_grad-cam_scores_scores_{model}_2_blend_basic_caco_bc_75", f"image_grad-cam_scores_scores_{model}_0_original_caco_caco"],
            [f"image_grad-cam_scores_scores_{model}_0_original_basic_basic", f"image_grad-cam_scores_scores_{model}_2_blend_basic_flat_bf_25", f"image_grad-cam_scores_scores_{model}_2_blend_basic_flat_bf_50_1", f"image_grad-cam_scores_scores_{model}_2_blend_basic_flat_bf_50_2", f"image_grad-cam_scores_scores_{model}_2_blend_basic_flat_bf_75", f"image_grad-cam_scores_scores_{model}_0_original_flat_flat"]
        ]
